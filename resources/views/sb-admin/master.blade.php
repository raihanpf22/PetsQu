...
<head>
    ...
    <title>Dashboard Admin | PetsQu</title>
    ...
    <link href="../vendor/sb-admin/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">PetsQu Admin</div>
            </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('table_product')}}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('table_user')}}">
                    <i class="fas fa-fw fa-table"></i>
    ...
    <script src="../vendor/sb-admin/vendor/sb-admin/js/sb-admin-2.min.js"></script>
    <!-- Page level plugins -->
